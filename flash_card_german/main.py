...
card_front_img = PhotoImage(file="images/german_flag.png")
card_back_img = PhotoImage(file="images/england_flag.png")
card_background = canvas.create_image(400, 263, image=card_front_img)
card_title = canvas.create_text(400, 150, text="Title", fill="white", font=("Arial", 40, "italic"))
