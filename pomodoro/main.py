...
def count_down(count):
    ...
    if count > 0:
        global timer
        # window.after(milliseconds, other arguments *args)
...
canvas = tk.Canvas(width=208, height=228, bg=YELLOW, highlightthickness=0)
# tk.Canvas(width=screen width, height=screen height, bg= background color,
# highlightthickness= thickness of the canvas border line)
tomato_img = tk.PhotoImage(file="tomato.png")
# tk.PhotoImage(file= image path to be imported)
timer_clock = "00:00"
canvas.create_image(101, 114, image=tomato_img)
